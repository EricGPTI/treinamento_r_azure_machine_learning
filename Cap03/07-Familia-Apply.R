...
# Agora calculando cada elemento da lista com sapply
?sapply
sapply(lista1, sum)
...
# Aplicando apply() a um data frame
...
# Gerando valores aleatórios com labels.
?gl
tabela_basquete <- 
...
# vapply()
?vapply
vapply(lista1, fivenum, c(Min. = 0, "lstQu." = 0, Median = 0, "3rd Qu." = 0, Max = 0))
