...
# Armazenados como números de dias desde 1 de Janeiro de 1970

# Time - representado por POSIXct
# Armazenados como números de segundos desde 1 de Janeiro de 1970

# Formatando Datas
# %d: dia do mês 2 dígitos (13)
# %m: mes em 2 dígitos (01)
...
as.Date("20 June, 2018", format = "%Y %B, %d")
...
# O vetor de números pode representar o número de dias, horas ou minutos (de 
# acordo com o que você quer converter)
# A linguagem R considera o ponto de início a data de 01 de Janeiro de 1970 e 
# contabiliza o total das horas, minutos ou segundos, aquilo que o vetor numérico representar.
dts = c(1127056501, 1104295502, 112923361, 1113547501, 1119826801, 11325119502, 1125298801, 1113289201)
mydates = dts
mydates


# POSIXct armazena os segundos desde uma data específica.
# Convertendo os valores numéricos (que podem represetnar horas, minutos ou segundos)
# desde 01 de Janeiro de 1970
# POSIXt é a classe principal e POSIXce POSIXlt são subcalsses
# Poderíamos usar aqui apenas POSIXct, qu eé a subcalsse (mas não podemos usar apenas a classe principal)
...
sono <- data.frame(bed.time = ymd_hms("2013-09-01 23:05:24",
                                     ...
                                     "2013-09-06 22:42:27",
                                     "2013-09-08 00:27:27"), 
                   rise.time=ymd_hms("2013-09-02 08:30:29",
                                     "2013-09-03 07:34:21",
                                     "2013-09-04 07:45:06",
                                     "2013-09-05 07:07:17",
                                     "2013-09-06 08:17:13",
                                     "2013-09-07 06:52:11",
                                     "2013-09-08 07:15:19"), 
                   sleep.time = dhours(c(6.74, 7.92, 7.01, 6.23,
                                         6.34, 7.42, 6.45)))
sono
